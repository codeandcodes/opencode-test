...
func (s *Server) registerAPI() {
	...
	s.mux.HandleFunc("GET /api/reports", s.handleReportsList)
	s.mux.HandleFunc("GET /api/reports/img/{name}", s.handleReportImg)
	s.mux.HandleFunc("GET /api/reports/{slug}", s.handleReportGet)
